...
/**
 * input_buf - function that buffers chained shell commands
...
/**
 * get_input - functioon that gets an input line minus the newline
 * @info: parameter struct containing arguments
 *
 * Return: bytes read
 */
...
/**
 * sigintHandler - function that blocks ctrl copy command
 * from keyboard
